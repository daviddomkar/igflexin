...
/// Defines the title font used for [RoundedListTile] descendants of a [RoundedListTileTheme].
///
...
enum RoundedListTileStyle {
  /// Use a title font that's appropriate for a [RoundedListTile] in a list.
  list,

  /// Use a title font that's appropriate for a [RoundedListTile] that appears in a [Drawer].
  drawer,
}

/// An inherited widget that defines color and style parameters for [RoundedListTile]s
/// in this widget's subtree.
///
/// Values specified here are used for [RoundedListTile] properties that are not given
/// an explicit non-null value.
///
/// The [Drawer] widget specifies a tile theme for its children which sets
/// [style] to [RoundedListTileStyle.drawer].
class RoundedListTileTheme extends InheritedWidget {
  /// Creates a list tile theme that controls the color and style parameters for
  /// [RoundedListTile]s.
  const RoundedListTileTheme({
    Key key,
    this.dense = false,
    this.style = RoundedListTileStyle.list,
    this.selectedColor,
    this.iconColor,
    this.textColor,
    this.contentPadding,
  ...
  /// Creates a list tile theme that controls the color and style parameters for
  /// [RoundedListTile]s, and merges in the current list tile theme, if any.
  ///
  /// The [child] argument must not be null.
  static Widget merge({
    Key key,
    bool dense,
    RoundedListTileStyle style,
    Color selectedColor,
    Color iconColor,
    Color textColor,
    ...
    return Builder(
      builder: (BuildContext context) {
        final RoundedListTileTheme parent = RoundedListTileTheme.of(context);
        return RoundedListTileTheme(
          key: key,
  ...
  /// If true then [RoundedListTile]s will have the vertically dense layout.
  final bool dense;

  /// If specified, [style] defines the font used for [RoundedListTile] titles.
  final RoundedListTileStyle style;

  /// If specified, the color used for icons and text when a [RoundedListTile] is selected.
  final Color selectedColor;

  /// If specified, the icon color used for enabled [RoundedListTile]s that are not selected.
  final Color iconColor;

  /// If specified, the text color used for enabled [RoundedListTile]s that are not selected.
  final Color textColor;

  /// The tile's internal padding.
  ///
  /// Insets a [RoundedListTile]'s contents: its [leading], [title], [subtitle],
  ...
  ///
  /// ```dart
  /// RoundedListTileTheme theme = RoundedListTileTheme.of(context);
  /// ```
  static RoundedListTileTheme of(BuildContext context) {
    final RoundedListTileTheme result = context.inheritFromWidgetOfExactType(RoundedListTileTheme);
    return result ?? const RoundedListTileTheme();
  }

  @override
  bool updateShouldNotify(RoundedListTileTheme oldWidget) {
...
/// Where to place the control in widgets that use [RoundedListTile] to position a
/// control next to a label.
///
/// See also:
///
///  * [CheckboxRoundedListTile], which combines a [RoundedListTile] with a [Checkbox].
///  * [RadioRoundedListTile], which combines a [RoundedListTile] with a [Radio] button.
enum RoundedListTileControlAffinity {
...
/// An exception is made for one-line RoundedListTiles for accessibility. Please
...
/// [RoundedListTile]s in [Card]s.
///
/// ![Different variations of RoundedListTile](https://flutter.github.io/assets-for-api-docs/assets/material/list_tile.png)
///
/// ```dart
/// ListView(
///   children: const <Widget>[
///     Card(child: RoundedListTile(title: Text('One-line RoundedListTile'))),
///     Card(
...
///     Card(
///       child: RoundedListTile(
///         title: Text('One-line dense RoundedListTile'),
///         dense: true,
///       ),
///     ),
///     Card(
...
///         title: Text('Two-line RoundedListTile'),
...
///         title: Text('Three-line RoundedListTile'),
///         subtitle: Text(
...
/// [trailing] and [leading] widgets in one-line RoundedListTiles should visually be
/// at most 32 ([dense]: true) or 40 ([dense]: false) in height, which may
/// conflict with the accessibility requirement.
///
/// For this reason, a one-line RoundedListTile allows the height of [leading]
/// and [trailing] widgets to be constrained by the height of the RoundedListTile.
...
/// {@tool sample}
///
/// Here is an example of a one-line, non-[dense] RoundedListTile with a
...
/// RoundedListTile, adjust the vertical padding to 8.0.
///
/// ```dart
/// RoundedListTile(
...
/// {@end-tool}
///
/// ## The RoundedListTile layout isn't exactly what I want
///
/// If the way RoundedListTile pads and positions its elements isn't quite what
...
/// See also:
///
///  * [RoundedListTileTheme], which defines visual properties for [RoundedListTile]s.
///  * [ListView], which can display an arbitrary number of [RoundedListTile]s
///    in a scrolling list.
///  * [CircleAvatar], which shows an icon representing a person and is often
///    used as the [leading] element of a RoundedListTile.
///  * [Card], which can be used with [Column] to show a few [RoundedListTile]s.
///  * [Divider], which can be used to separate [RoundedListTile]s.
///  * [RoundedListTile.divideTiles], a utility for inserting [Divider]s in between [RoundedListTile]s.
///  * [CheckboxRoundedListTile], [RadioRoundedListTile], and [SwitchRoundedListTile], widgets
///    that combine [RoundedListTile] with other controls.
...
class RoundedListTile extends StatelessWidget {
  ...
  ///
  /// If this property is null then its value is based on [RoundedListTileTheme.dense].
  ///
  ...
  /// can be overridden with a [RoundedListTileTheme].
  final bool selected;
  ...
  Color _iconColor(ThemeData theme, RoundedListTileTheme tileTheme) {
  ...
  Color _textColor(ThemeData theme, RoundedListTileTheme tileTheme, Color defaultColor) {
    if (!enabled) return theme.disabledColor;
  ...
  bool _isDenseLayout(RoundedListTileTheme tileTheme) {
    return dense != null ? dense : (tileTheme?.dense ?? false);
  }

  TextStyle _titleTextStyle(ThemeData theme, RoundedListTileTheme tileTheme) {
    TextStyle style;
    if (tileTheme != null) {
      switch (tileTheme.style) {
        case RoundedListTileStyle.drawer:
          style = theme.textTheme.body2;
          break;
        case RoundedListTileStyle.list:
  ...
  TextStyle _subtitleTextStyle(ThemeData theme, RoundedListTileTheme tileTheme) {
  ...
  Widget build(BuildContext context) {
    ...
    final RoundedListTileTheme tileTheme = RoundedListTileTheme.of(context);
...
// Identifies the children of a _RoundedListTileElement.
enum _RoundedListTileSlot {
  leading,
  title,
  subtitle,
  trailing,
...
class _RoundedListTile extends RenderObjectWidget {
  ...
  @override
  _RoundedListTileElement createElement() => _RoundedListTileElement(this);

  @override
  _RenderRoundedListTile createRenderObject(BuildContext context) {
    return _RenderRoundedListTile(
      isThreeLine: isThreeLine,
      isDense: isDense,
      textDirection: textDirection,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderRoundedListTile renderObject) {
    renderObject
      ..isThreeLine = isThreeLine
      ..isDense = isDense
      ..textDirection = textDirection
...
class _RoundedListTileElement extends RenderObjectElement {
  _RoundedListTileElement(_RoundedListTile widget) : super(widget);

  final Map<_RoundedListTileSlot, Element> slotToChild = <_RoundedListTileSlot, Element>{};
  final Map<Element, _RoundedListTileSlot> childToSlot = <Element, _RoundedListTileSlot>{};

  @override
  _RoundedListTile get widget => super.widget;

  @override
  _RenderRoundedListTile get renderObject => super.renderObject;
  ...
  void forgetChild(Element child) {
    ...
    final _RoundedListTileSlot slot = childToSlot[child];
    childToSlot.remove(child);
    slotToChild.remove(slot);
  }

  void _mountChild(Widget widget, _RoundedListTileSlot slot) {
  ...
  void mount(Element parent, dynamic newSlot) {
    ...
    _mountChild(widget.leading, _RoundedListTileSlot.leading);
    _mountChild(widget.title, _RoundedListTileSlot.title);
    _mountChild(widget.subtitle, _RoundedListTileSlot.subtitle);
    _mountChild(widget.trailing, _RoundedListTileSlot.trailing);
  }

  void _updateChild(Widget widget, _RoundedListTileSlot slot) {
    final Element oldChild = slotToChild[slot];
    final Element newChild = updateChild(oldChild, widget, slot);
    if (oldChild != null) {
      childToSlot.remove(oldChild);
  ...
  @override
  void update(_RoundedListTile newWidget) {
    super.update(newWidget);
    assert(widget == newWidget);
    _updateChild(widget.leading, _RoundedListTileSlot.leading);
    _updateChild(widget.title, _RoundedListTileSlot.title);
    _updateChild(widget.subtitle, _RoundedListTileSlot.subtitle);
    _updateChild(widget.trailing, _RoundedListTileSlot.trailing);
  }

  void _updateRenderObject(RenderObject child, _RoundedListTileSlot slot) {
    switch (slot) {
      case _RoundedListTileSlot.leading:
        renderObject.leading = child;
        break;
      case _RoundedListTileSlot.title:
        renderObject.title = child;
        break;
      case _RoundedListTileSlot.subtitle:
        renderObject.subtitle = child;
        break;
      case _RoundedListTileSlot.trailing:
  ...
  void insertChildRenderObject(RenderObject child, dynamic slotValue) {
    ...
    assert(slotValue is _RoundedListTileSlot);
    final _RoundedListTileSlot slot = slotValue;
...
class _RenderRoundedListTile extends RenderBox {
  _RenderRoundedListTile({
  ...
  final Map<_RoundedListTileSlot, RenderBox> slotToChild = <_RoundedListTileSlot, RenderBox>{};
  final Map<RenderBox, _RoundedListTileSlot> childToSlot = <RenderBox, _RoundedListTileSlot>{};

  RenderBox _updateChild(RenderBox oldChild, RenderBox newChild, _RoundedListTileSlot slot) {
    if (oldChild != null) {
      dropChild(oldChild);
      childToSlot.remove(oldChild);
      slotToChild.remove(slot);
  ...
  set leading(RenderBox value) {
    _leading = _updateChild(_leading, value, _RoundedListTileSlot.leading);
  }

  RenderBox _title;
  RenderBox get title => _title;
  set title(RenderBox value) {
    _title = _updateChild(_title, value, _RoundedListTileSlot.title);
  }

  RenderBox _subtitle;
  RenderBox get subtitle => _subtitle;
  set subtitle(RenderBox value) {
    _subtitle = _updateChild(_subtitle, value, _RoundedListTileSlot.subtitle);
  }

  RenderBox _trailing;
  RenderBox get trailing => _trailing;
  set trailing(RenderBox value) {
    _trailing = _updateChild(_trailing, value, _RoundedListTileSlot.trailing);
  }
