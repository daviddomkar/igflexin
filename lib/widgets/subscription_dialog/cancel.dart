...
class Cancel extends StatefulWidget {
  ...
  @override
  _CancelState createState() {
    return _CancelState();
  }
}

class _CancelState extends State<Cancel> with SingleTickerProviderStateMixin {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Subscription will be canceled at the and of the current period. You can renew it anytime durring this period.',
              textAlign: TextAlign.center,
            ),
          ),
          GradientButton(
