...
class InstagramAccountsSpinnerAdapter(private val activity: Activity, private val resource: Int, private val accounts: List<InstagramAccount>) : ArrayAdapter<InstagramAccount>(activity, resource, accounts) {
