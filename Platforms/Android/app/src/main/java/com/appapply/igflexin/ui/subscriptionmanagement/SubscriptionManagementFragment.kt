package com.appapply.igflexin.ui.subscriptionmanagement
...
class SubscriptionManagementFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = SubscriptionManagementFragment()
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(SubscriptionManagementViewModel::class.java)
