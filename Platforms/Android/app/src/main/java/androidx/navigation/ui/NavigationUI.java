...
public class NavigationUI {
    ...
    public static void setOnNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener listener) {
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        if (onNavDestinationSelected(item, navController, true)) {
                            ...
                            if(onNavigationItemSelectedListener != null) return onNavigationItemSelectedListener.onNavigationItemSelected(item); else return false;
                        }
                    }
                });
